	...
	return (
		<BentoLayout>
			...
			<div className="flex flex-col gap-y-4 h-full">
				<div className="bg-green-500 p-4 text rounded-xl border text-white text-center font-bold flex-grow">
					<Link href="#">
						<div>
			...
			<div className="row-span-2 bg-purple-500 rounded-xl border p-4 text-white font-bold">
				<Link href="/dashboard/workouts" className="w-full h-full">
					<div className="flex gap-3 items-center align-middle">
			...
			<div className="col-span-2 row-span-2 bg-blue-500 p-4 text-white text-center font-bold rounded-xl border bg-[url('../../public/pexels-mister-mister-3490348.jpg')] bg-cover bg-center">
				<Link href="/dashboard/workout-videos" className={buttonVariants({ variant: "ghost" })}>
					Main Area
				</Link>
			</div>

			<div className="bg-red-500 p-4 rounded-xl border text-white font-bold">
				<Link href="/dashboard/motivations">
					<div className="flex gap-3 items-center align-middle">
						<FlowerIcon width={30} />
						<h4 className="scroll-m-20 text-xl font-semibold tracking-tight">
							Motivations
